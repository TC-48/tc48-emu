...
def main():
    ...
    types = [
        ("doublet", 2, "tc48_doublet", "uint8_t"),
        ("triplet", 3, "tc48_triplet", "uint8_t"),
        ("quadruplet", 4, "tc48_quadruplet", "uint8_t"),
        ("tryte", 6, "tc48_tryte", "uint8_t"),
        ("quarter", 12, "tc48_quarter", "uint16_t"),
        ("half", 24, "tc48_half", "uint32_t"),
        ("word", 48, "tc48_word", "uint64_t"),
    ]
