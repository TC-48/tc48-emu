...
def main() -> int:
    ...
    # 32-bit table
    content.append("const tc48_u32b tc48_pow3_u32[TC48_MAX_SAFE_TRITS_U32] = {")
    p = 1
    ...
    # 64-bit table
    content.append("const tc48_u64b tc48_pow3_u64[TC48_MAX_SAFE_TRITS_U64] = {")
    p = 1
    ...
    # 128-bit table
    content.append("const tc48_u128b tc48_pow3_u128[TC48_MAX_SAFE_TRITS_U128] = {")
    p = 1
    for _ in range(n_u128):
        ...
        if high == 0:
            content.append(f"    (tc48_u128b){low}ULL,")
        else:
            content.append(f"    ((tc48_u128b){high}ULL << 64 | {low}ULL),")
        p *= 3
    content.append("};")
