...
void tc48_cpu_set_reg_imm(tc48_cpu_regs* regs, tc48_reg_id dst, tc48_imm* imm);
void tc48_cpu_mov_reg(tc48_cpu_regs* regs, tc48_quarter width, tc48_reg_id dst, tc48_reg_id src);
